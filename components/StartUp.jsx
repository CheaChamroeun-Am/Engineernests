  ...
  return (
    <div className="bg-primary1 mt-32 p-5 pt-10 pb-20" id="startup">
      <div className="px-6 mx-auto container pt-10">
        <h1 className=" text-white text-3xl md:text-3xl lg:text-3xl xl:text-4xl 2xl:text-5xl font-bold leading-tight uppercase">
          For Startup
        </h1>
        <div className="section1">
          ...
          <div className="mt-10 flex flex-row justify-evenly gap-2 px-4 md:px-72">
            <button
              ...
              className="border-primary3 border-2 
            text-white focus:text-white
            active:bg-primary3 p-1 px-4 rounded-md
            focus:ring-primary3 focus:bg-primary3 focus:ring "
            >
              All
            </button>
            <button
          ...
          <div
            className="grid grid-cols-1 items-center content-center md:grid-cols-4 lg:grid-cols-4 mt-10"
          >
            {portfolioList.map((item, index) => (
              ...
              >
                ...
                <h1 className="text-[12px] text-gray-500 pb-3">
                  {item.desc}
                </h1>
              </div>
            ))}
